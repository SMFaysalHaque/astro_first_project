...
<nav class="">
  <div class="flex flex-wrap items-center justify-between border border-pink-600 w-full">
    <div class="logo">
      <p class="font text-3xl font-bold">IMS</p>
    </div>
    <div class="list-topic">
      <ul class="flex">
        <li class="px-5">All Units</li>
        <li class="px-5">Persons</li>
        <li class="px-5">Unit Types</li>
      </ul>
    </div>
    <div class="">
